...
export class RequestType {
    ...
    static readonly Launch = new RequestType(1, 'LaunchRequest');
    static readonly Intent = new RequestType(2, 'IntentRequest');
    static readonly SessionEnded = new RequestType(3, 'SessionEndedRequest');
